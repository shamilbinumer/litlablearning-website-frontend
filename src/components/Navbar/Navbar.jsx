    ...
    <div className='NavbarMainWrapper'>
      <div className="desktop-nav-wrapper">
        <div className={`desktop-navigation-bar  ${isScrolled ? 'scrolled' : ''}`}>
          ...
          <div className="nav-right">
            ...
            <div>
            <a href="https://litlablearninglive.web.app/#/login" className='login'>Log in</a>
            <a href="https://litlablearninglive.web.app/#/signup" className='login sign-up'>Sign Up</a>
      ...
      <nav className="navbar navbar-expand-lg bg-body-tertiary">
        <div className="container-fluid">
          ...
          <a href="https://litlablearninglive.web.app/#/login" className="login-btn">
            Log in 
          </a>
          <button
